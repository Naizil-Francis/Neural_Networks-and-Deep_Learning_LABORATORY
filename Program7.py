...
# Resize images to fit VGG input shape
...
# Train the model
vgg16_history = vgg16_model.fit(x_train, y_train, epochs=10, batch_size=64, validation_data=(x_test, y_test))
...
# Train the model
vgg19_history = vgg19_model.fit(x_train, y_train, epochs=10, batch_size=64, validation_data=(x_test, y_test))
